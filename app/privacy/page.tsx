...
export default function PrivacyPage() {
  return <main className="privacy-page">
    ...
    <article>
      ...
      <p>登录后可从书架的“数据与隐私”导出一个 ZIP，其中包含机器可读清单和全部云端 EPUB；也可以删除全部 Dawn 云端数据并清理当前浏览器中的 Dawn 数据。备份或必要运行日志可能按基础设施策略保留到到期，但不会被静默恢复到账号。</p>
      <p>PDF、PDF 高亮和本机查阅记录不在云端导出包中。请保留原始 PDF；删除前关闭其他 Dawn Reader 标签页，以便当前页面完整清除浏览器数据库。</p>
